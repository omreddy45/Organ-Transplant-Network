...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 cursor-default">
      {/* Left Content Section */}
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-primary/90 via-primary to-primary/80 p-12 text-primary-foreground select-none">
        <div className="relative z-20">
          <div className="flex items-center gap-2 text-lg font-semibold select-none">
            <div className="size-8 rounded-lg bg-primary-foreground/10 backdrop-blur-sm flex items-center justify-center">
              <Sparkles className="size-4" />
            </div>
            <span>OrganConnect</span>
          </div>
        </div>
      ...
      <div className="flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-[420px]">
          <div className="lg:hidden flex items-center justify-center gap-2 text-lg font-semibold mb-12 select-none">
          ...
          <div className="text-center mb-10 select-none">
            ...
            <p className="text-muted-foreground text-sm">Join the organ donation network today</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <div className="flex gap-4 mb-2 select-none">
              ...
              >
                <User className={`w-6 h-6 mb-2 ${role === 'patient' ? 'text-primary' : 'text-muted-foreground'}`} />
                <span className={`text-sm font-medium ${role === 'patient' ? 'text-primary' : 'text-muted-foreground'}`}>Patient</span>
              </button>
              <button
                type="button"
            ...
            <div className="space-y-2 select-none">
              <Label htmlFor="name" className="text-sm font-medium cursor-default">Full Name</Label>
              <Input
                id="name"
                type="text"
            ...
            <div className="space-y-2 select-none">
              <Label htmlFor="email" className="text-sm font-medium cursor-default">Email</Label>
              <Input
                id="email"
                type="email"
            ...
            <div className="space-y-2 select-none">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="py-3 pl-4 pr-10 h-auto bg-background border-border/60 focus:border-primary"
                />
                <button
                  type="button"
          ...
          <div className="text-center text-sm text-muted-foreground mt-8 select-none cursor-default">
